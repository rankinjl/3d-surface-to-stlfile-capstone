...
/*
 * Only used for the Triangle2D objects for the initial bound tesselation
 */
public class Vector2D {
    ...
    //added by Jessica for Triangle3D usage in calculating side triangle normal 11/20
    //Pre: need to find the length of this vector
    //Post: length of vector calculated and returned as double
    ...
    //added by Jessica
    //Pre: need to now if this vector equals vector b
    //Post: true returned if equal, false otherwise
