 ...
 */
public class DelaunayTriangulationView implements GLEventListener, MouseListener {

    private static final Dimension DIMENSION = new Dimension(1366,768);
    ...
    public void setDelaunayTriangulator(DelaunayTriangulator dT)
    {
    ...
    public void plot() {
        ...
        DelaunayTriangulationView ex = this;//new DelaunayTriangulationPlotter();
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        for (int i = 0; i < delaunayTriangulator.getTriangles().size(); i++) {
            ...
            gl.glVertex2d(a.x, DIMENSION.getHeight() - a.y);

            gl.glVertex2d(b.x, DIMENSION.getHeight() - b.y);
            gl.glVertex2d(c.x, DIMENSION.getHeight() - c.y);
        ...
        for (Vector2D vector : pointSet) {
            gl.glVertex2d(vector.x, DIMENSION.getHeight() - vector.y);
        }
